...
Attaches each feature evaluation to the active OpenTelemetry `Span` — either as span *attributes* (default,
...
Set `FEATUREHUB_OTEL_SPAN_AS_EVENTS=true` to switch to events mode. The plugin is safe to include even when
