...
public class EdgeFeatureHubConfig implements FeatureHubConfig {
  ...
  public ClientContext newContext(@Nullable FeatureRepositoryContext repository,
                                  @Nullable ObjectSupplier<EdgeService> edgeService) {
    if (repository == null) {
   ...
   */
  @NotNull
  protected ObjectSupplier<EdgeService> loadEdgeService(@NotNull  FeatureRepositoryContext repository) {
    ...
    for(FeatureHubClientFactory f : loader) {
      ObjectSupplier<EdgeService> edgeService = f.createEdgeService(this, repository);
      if (edgeService != null) {
        return edgeService;
      }
    }
  ...
  @Override
  public void setEdgeService(@NotNull ObjectSupplier<EdgeService> edgeService) {
    this.edgeService = edgeService;
  }

  @Override
  @NotNull
  public ObjectSupplier<EdgeService> getEdgeService() {
    if (edgeService == null) {
